  ...
  <main class="container">
    <div class="columns mt-3">
      ...
      <transition name="fade" mode="out-in">
        <div
          class="col-12 mt-3 pt-2 p-centered"
        ...
        >
          <div class="col-3 col-sm-9 col-md-6 p-centered text-center">
            ...
            <span style="vertical-align: middle" class="ml-2 mb-2">
              OTA Success
            </span>
            <br />
            <br />
        ...
        >
          <div class="col-3 col-sm-9 col-md-6 p-centered">
            ...
            <div class="form-group pt-2 mt-2">
              <label class="form-radio form-inline mr-2">
                <input
                  ...
                  value="firmware"
                  v-model="type"
                /><i class="form-icon"></i> Firmware
              </label>
              <label class="form-radio form-inline ml-2 mr-2">
                <input
                  type="radio"
                  name="firmwaretype"
                  for="firmwaretype"
                  value="filesystem"
                  v-model="type"
                /><i class="form-icon"></i> Filesystem
              </label>
            </div>
            <div v-if="source === 'remoteSource'" class="form-group pt-2 mt-3">
            ...
            <div v-else class="form-group pt-2 mt-3">
              <input
      ...
      <transition name="fade" mode="out-in">
        <div
          class="col-12 mt-3 mb-2 pt-2 p-centered"
    ...
    <transition name="fade" mode="out-in">
      <div class="columns mt-3" v-if="!loading">
        <div class="col-12 text-center">
          <span class="label label-rounded mr-2">{{ deviceData.id }}</span> -
          <span class="label label-rounded label-primary ml-2">{{
            deviceData.hardware
          }}</span>
        </div>
      </div>
...
.card {
  border: 0;
  box-shadow: 0 0.25rem 1rem rgba(48, 55, 66, 0.1);
